...
public class KPSPublicSoapProxy implements tr.gov.nvi.tckimlik.WS.KPSPublicSoap {
  ...
  public boolean TCKimlikNoDogrula(String l, java.lang.String ad, java.lang.String soyad, Date date) throws java.rmi.RemoteException{
    if (kPSPublicSoap == null)
      _initKPSPublicSoapProxy();
    return kPSPublicSoap.TCKimlikNoDogrula(l, ad, soyad, date);
  }

public boolean TCKimlikNoDogrula(long nationalId, String firstName, String lastName, Date birthDate) {
